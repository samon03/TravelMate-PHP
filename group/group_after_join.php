...
<div id="container" style="background-color: #d8f3e5; padding: 5px;">
...
<div id="session-name">
	Your Name: <input type="text" value="<?php echo $username ?>" class="session-text" disabled>
</div>
...
<div id="form-container">
    ...
    <div class="form-btn">
    	<input type="button" value="Send" id="btn" name="btn" onclick="post()"/>
    </div>
</div>
</form>
